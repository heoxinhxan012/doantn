					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
								...
								<div id="km-detail">
									...
									<div class="fk-main">
										<div class="fk-sales">
											...
											<ul>
												<li>Tặng PMH giảm giá 30% cho lần mua thứ 2</li>
											</ul>
											<ul>
												<li>Tặng thêm 1 thỏi son dưỡng khi hóa đơn trên 1 triệu đồng <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div style="margin-top: 20px;">
								<b>Tình trạng</b>
								<br>
								<span>Sản phẩm nguyên hộp, nguyên tem của nhà sản xuất. Cam kết là mỹ phẩm chính hãng 100%</span>
							</div>
							<div style="margin-top: 20px;">
								<b>Bảo hành</b>
								<br>
								<span>Hoàn trả lại tiền 100% khi sản phẩm không đúng với cam kết và sẽ chịu hoàn toàn trách nhiệm nếu phát hiện sản phẩm không chính hãng</span><a href="#" style="color:red"> (Chi tiết)</a>
							</div>
						</div>
					</div>
