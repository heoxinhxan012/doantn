...
<section>
		...
		<div class="col-md-4 col-12">
			...
			<ul class="list-unstyled">
				<li class="clearfix">
					...
					<span style="color: black"> Triều Khúc - Thanh Xuân - Hà Nội</span><br>
				</li>
				<li class="clearfix">
					<i class="fa fa-phone fa-1x" style="color:#0f9ed8;padding: 20px;  "></i>
					<span style="color: black">0974073491</span>
				</li>
				<li class="clearfix">
					<i class="fa fa-envelope fa-1x " style="color:#0f9ed8; padding: 20px; "></i>
					<span style="color: black"><a href="mailto:sale.24hstore@gmail.com">nvthang1612@gmail.com</a></span>
				</li>
			</ul>
		</div>
	...
	<div class="col-md-12 col-lg-12 col-xs-12 col-12">
		...
		<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d7450.542252160472!2d105.79639787334868!3d20.981766244095184!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1svi!2s!4v1651659305667!5m2!1svi!2s" width="1200" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		</div>
	</div>
</div>
