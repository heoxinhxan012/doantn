        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <ul class="list-unstyled social pull-right">
                  <li><a href="https://www.facebook.com/vanthang.1612"><i class="fab fa-facebook-f"></i></a></li>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="about-store">
                 PhucDuc Store - Mỹ phẩm chính hãng
             </div>
         </div>
         <div class="col-xs-12 col-sm-6">
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>Triều Khúc - Thanh Xuân - Hà Nội</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-phone"></i>
                        <span>0974073491</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:nvthang1612@gmail.com">nvthang1612@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>
